# **Operationalize and Infuse Trust in AI Models using KFServing**

By ***Animesh Singh*** and ***Dan Sun***

With inputs from : ***Tommy Li, Paul Vaneck, Andrew Butler, Srinivasan Parthasarathy, Yuzhui Liu..***

[<u>According to Gartner</u>](https://www.gartner.com/document/3994810), "organizations are now interested not just in a “pathway” to production but in a “speedway” to production. However, most enterprises become dismayed when they find out how exceptionally challenging it is to operationalize AI, as opposed to how (deceptively) easy it is to perform proof of concepts (POCs) or small-scale projects."

One key aspect of deploying models in production is being able to monitor the predictions for various metrics, and explaining the decisions the model is making. [<u>IDC predicts</u>](https://www.idc.com/getdoc.jsp?containerId=US46917020&pageType=PRINTFRIENDLY) by 2022, over 60% of consumer-focused AI Decisioning Systems in Finance, Healthcare, Government, and other regulated sectors will include provisions to explain their analysis and decisions. *Gartner states* that AI systems that have explainability as a standard feature will be expected.
...
### KFServing v1beta1 API and V2 Inference Protocol
...
### KFServing delivered on OpenShift
...
### LFAI Trusted AI Projects on AI Explainability and Adversarial Robustness integrated with KFServing
...
### **Iter8 integration with KFServing enables automated rollouts driven by metrics** 
