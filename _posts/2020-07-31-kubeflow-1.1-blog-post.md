...
- [Seldon Core 1.1](https://docs.seldon.io/projects/seldon-core/en/latest/reference/release-1.1.0.html), which handles scaling to thousands of production ML models and provides advanced ML capabilities including Advanced Metrics, Request Logging, Explainers, Outlier Detectors, A/B Tests, Canaries and more.
- The [Feast](https://feast.dev/) 0.3 feature store, which allows ML teams to define, manage, discover, and serve ML features.
