...
**Tutorial 2** - [Deploy and run your first interfere service with KServe Tutorial](https://github.com/js-ts/website-1/blob/master/content/en/docs/external-add-ons/kserve/first_isvc_kserve.ipynb) Run your first interface service on Kubeflow 1.5 i.e. define, create and check an InferenceService, post an interfere request and receive response.  Optionally run performance tests.
