...
* OIDC-authservice has been removed in favor of oauth2-proxy
...
* Spark Operator 2.1.0 in Kubeflow platform, although not installed yet by default
...
* Kubernetes and container security best practices (CISO compatibility):
    ...
    * Istio-CNI as default for rootless postponed to Kubeflow [1.10.1](https://github.com/kubeflow/manifests/milestone/2)

Trivy CVE scans March 21 2025:

![CVE Scans](../images/2025-03-26-kubeflow-1.10-release/csv-scans.png)
...
Working Group leads : Andrej Velcichkevich, Julius von Kohout,  Mathew Wick, …

Kubeflow Steering Committee : Andrej Velichkevich, Julius von Kohout, Yuan Tang, Johnu George, Francisco Javier Araceo

Participating Distributions : Charmed Kubeflow (Canonical), IBM IKS, Nutanix, OpenShift AI (RedHat), Oracle Cloud
Infrastructure, DeployKF, VMWare, QBO.
